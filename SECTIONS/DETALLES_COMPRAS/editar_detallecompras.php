                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="id_detalle" class="form-control"
                                    value="<?php echo $row['id_detalle']; ?>" disabled>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="compra_insertado" name="compra_insertado" required>
                                    ...
                                    foreach ($compras as $compra) {
                                        $selected = ($compra['id_compra'] == $row['compra_id']) ? 'selected' : '';
                                        echo '<option value="' . $compra['id_compra'] . '" ' . $selected . '>ID: ' . $compra['id_compra'] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="number" id="cantidad_insertado" name="cantidad_insertado"
                                    class="form-control" value="<?php echo $row['cantidad']; ?>" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="number" id="precio_unitario_insertado" name="precio_unitario_insertado"
                                    class="form-control" value="<?php echo $row['precio_unitario']; ?>" required>
                            </div>
                        </div>
                    </div>
