                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <fieldset disabled>
                                    ...
                                    <input type="text" id="inventario_id_editado" class="form-control" 
                                    placeholder="<?php echo $row['id_inventario'] ?>">
                                </fieldset>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                name="producto_id_editado" aria-label="Large select example">
                                <?php
                                    $result = getProductos();
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control form-select form-select-lg mb-3" 
                                name="almacen_id_editado" aria-label="Large select example">
                                <?php
                                    $result = getAlmacenes();
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="cant_disp_editado" name="cant_disp_editado" class="form-control" 
                                value="<?php echo $row['cant_disp'] ?>">
                            </div>
                        </div>
                    </div>
