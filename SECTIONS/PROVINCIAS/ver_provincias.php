...
<div class="modal fade" id="ver<?php echo $row['id_provincia']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="../DAL/funciones_provincias.php" method="POST">
                    ...
                    <input type="hidden" name="accion" value="ver_provincias">
