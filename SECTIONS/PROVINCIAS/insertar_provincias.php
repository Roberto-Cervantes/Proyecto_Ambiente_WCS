        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="../DAL/funciones.php" method="POST">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <fieldset disabled>
                                    ...
                                    <input type="text" id="id_provincia" class="form-control" placeholder="0">
                                </fieldset>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <input type="hidden" name="accion" value="insertar_provincias">
                    <input type="hidden" name="id_provincia" value=0>
                    <br>
