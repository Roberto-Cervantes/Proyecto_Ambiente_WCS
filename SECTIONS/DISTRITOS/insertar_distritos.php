        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="../DAL/funciones_distritos.php" method="POST">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <fieldset disabled>
                                    ...
                                    <input type="text" id="id_distritos" class="form-control" placeholder="0">
                                </fieldset>
                            </div>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <input type="hidden" name="accion" value="insertar_distritos">
                    <input type="hidden" name="id_distritos" value=0>
                    <input type="hidden" name="canton" value="<?php echo "1"; ?>">
                    <br>
