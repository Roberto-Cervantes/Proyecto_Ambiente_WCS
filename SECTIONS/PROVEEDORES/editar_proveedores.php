...
<div class="modal fade" id="editar<?php echo $row['id_proveedor']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h3 class="modal-title" id="exampleModalLabel">Editar al Proveedor
            ...
            <div class="modal-body">
                ...
                <form action="../DAL/funciones_proveedores.php" method="POST">
                    ...
                    <input type="hidden" name="accion" value="editar_proveedores">
