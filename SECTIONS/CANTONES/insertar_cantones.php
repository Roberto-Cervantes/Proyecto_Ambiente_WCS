        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="../DAL/funciones_cantones.php" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select class="form-control form-select form-select-lg mb-3" name="provincia_insertada" aria-label="Large select example">
                                    <?php
                    ...
                    <input type="hidden" name="accion" value="insertar_cantones">
                    <input type="hidden" name="id_canton" value=0>
                    <input type="hidden" name="provincia" value="<?php echo "1"; ?>">
                    <br>
