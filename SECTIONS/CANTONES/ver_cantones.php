...
<div class="modal fade" id="ver<?php echo $row['id_canton']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <fieldset disabled>
                                    ...
                                    <input type="text" id="id_canton" class="form-control" 
                                    placeholder="<?php echo $row['id_canton'] ?>">
                                </fieldset>
                            </div>
                        </div>
                        <div class="col-sm-6">
