...
<div class="modal fade" id="editar<?php echo $row['id_producto']; ?>" tabindex="-1" role="dialog"
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" id="id_producto" class="form-control"
                                    value="<?php echo $row['id_producto']; ?>" disabled>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="mb-3">
                                <label for="proveedor_editado" class="form-label">Proveedor</label>
                                <select class="form-control" id="proveedor_editado" name="proveedor_editado" required>
                                    <option value="" disabled>Selecciona un proveedor</option>
                                    <?php
                                    $proveedores = getProveedores(); // Obtener todos los proveedores
                                    foreach ($proveedores as $proveedor) {
                                        $selected = ($proveedor['id_proveedor'] == $row['id_proveedor']) ? 'selected' : '';
