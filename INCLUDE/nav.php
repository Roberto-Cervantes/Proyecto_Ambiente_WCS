      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="compras.php">Registrar Compra</a></li>
            <li role="separator" class="divider"></li>
            <li class="dropdown-header">Registrar factura</li>
            <li><a href="facturaciones.php">Facturar</a></li>
            <li role="separator" class="divider"></li>
            <li class="dropdown-header">Inventarios</li>
            <li><a href="inventarios.php">Revisar inventario</a></li>
          </ul>
        </li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="cantones.php">Cantones</a></li>
